#!/usr/bin/env python3
"""
plot_bayes_v4_1misc_heatmap.py
...
Run from repo root:
    python3 analysis-Bayesian/plot_bayes_v4_1misc_heatmap.py
"""
import os
...
from bayes_common import (HERE, BASE_TASK, ROWS_PATH_V4, IDS, SHORT, CMAP, NORM,
...
def main():
    rows = load_rows(ROWS_PATH_V4, expect=240)
    ...
    p = os.path.join(HERE, 'bayes_v4_1misc_heatmap.png')
    ...
    cbar.set_label('posterior marginal P(named rule | trace)', fontsize=9)
    pc = os.path.join(HERE, 'bayes_v4_1misc_heatmap_combined.png')
